...
Adds **+5, +10, -5, and -10** buttons to the GemStone IV skill trainer page so you don't have to click +1 or -1 a hundred times.
...
4. New buttons appear next to every skill — click to train in bulk
5. Submit your training as normal when you're done

The original +1 / -1 buttons still work. TURBOTRAINER just adds the extra ones.
